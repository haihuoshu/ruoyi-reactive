...
//     */
//    @PostMapping("/upload")
//    public AjaxResult uploadFile(MultipartFile file,ServerWebExchange exchange) {
//        try {
//            // 上传文件路径
//            String filePath = RuoYiConfig.getUploadPath();
//            // 上传并返回新文件名称
//            String fileName = FileUploadUtils.upload(filePath, file);
//            String url = ServerConfig.getDomain(exchange) + fileName;
...
//     */
//    @PostMapping("/uploads")
//    public AjaxResult uploadFiles(List<MultipartFile> files, ServerWebExchange exchange) throws Exception {
//        try {
//            // 上传文件路径
//            String filePath = RuoYiConfig.getUploadPath();
